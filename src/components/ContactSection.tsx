    ...
    <section id="contact" className="py-24 border-t border-border/50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-card/50 border border-border/50 p-8 md:p-12 rounded-3xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {socialLinks.map((social) => (
                <Link 
                  ...
                  href={social.href} 
                  target="_blank"
                  className={`flex items-center gap-3 text-muted-foreground transition-colors group ${social.color}`}
                >
                  <div className="p-2 border border-border group-hover:border-current rounded-lg transition-colors">
            ...
            <div className="mt-12 pt-8 border-t border-border/50">
              ...
              <Button variant="link" className="p-0 text-accent font-bold uppercase tracking-widest h-auto" asChild>
                <Link href="https://github.com/Diffraction-Works" target="_blank" className="flex items-center gap-2">
                  Check out our Github <ArrowRight className="w-4 h-4" />
                </Link>
              </Button>
            </div>
          </div>
