...
export function PhotographyFeed() {
  const instagramPosts = [
    "https://www.instagram.com/p/DT4guPZkq7M/",
    "https://www.instagram.com/p/DTrbkktErTn/",
    "https://www.instagram.com/p/DTrdXPAEqRC/"
  ];
        ...
        <ScrollReveal animation="fade-up" delay={400}>
          <div className="mt-12 text-center">
            <Button 
              variant="outline" 
              size="lg" 
              className="rounded-full px-8 border-accent/20 hover:border-accent hover:bg-accent/10 transition-all duration-300 hover:scale-105 group" 
              asChild
            >
              <Link href="https://www.instagram.com/diffraction_works/" target="_blank">
                Follow @diffraction_works
                <Instagram className="w-5 h-5 ml-2 transition-transform group-hover:rotate-12" />
              </Link>
            </Button>
          </div>
        </ScrollReveal>
